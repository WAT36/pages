...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b56ef9b0430fc9f77b24ea3ceb752db82ef1363445bac29396b2c7548c8d60c0.js',function(){input.required=false;search();});}
