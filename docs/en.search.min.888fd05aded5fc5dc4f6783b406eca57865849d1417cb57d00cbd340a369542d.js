...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a16507238c775ffcb0955f4a23f639bf62d94babb1299478e3d7501b86fcede0.js',function(){input.required=false;search();});}
