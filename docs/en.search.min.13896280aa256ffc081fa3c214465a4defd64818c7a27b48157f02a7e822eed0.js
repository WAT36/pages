...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f663a35886601ec1137909fefdfd4393371e2e4790f22ba12288cd5eb306057c.js',function(){input.required=false;search();});}
