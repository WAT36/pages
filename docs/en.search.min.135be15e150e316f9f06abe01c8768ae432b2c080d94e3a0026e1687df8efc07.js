...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.67021569b64a5290969b1b7fc3dde27972e2d20ebd4b5ea8200dd4ed7b1eeb09.js',function(){input.required=false;search();});}
