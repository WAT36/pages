...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.60cbf7eb0ec4d8d912df2861910ab4ff29c392fff852c1615c653f92acf8be79.js',function(){input.required=false;search();});}
