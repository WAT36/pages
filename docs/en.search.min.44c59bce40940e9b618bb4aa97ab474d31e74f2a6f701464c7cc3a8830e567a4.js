...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1cc8e9eddd11c61ed46acf6e7bf9c364ccbb8ed29ea3ce74b1033efe1d34c7bf.js',function(){input.required=false;search();});}
