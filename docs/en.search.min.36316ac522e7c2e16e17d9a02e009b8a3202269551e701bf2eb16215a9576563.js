...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.51360f13b7be289eeef1fe936d6088a4c0a4c2507723840722a79d0b64d31da6.js',function(){input.required=false;search();});}
