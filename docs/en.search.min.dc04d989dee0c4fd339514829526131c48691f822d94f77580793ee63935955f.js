...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b7fe8230f97af91859bc0d629160a020009ef81ee325b8c9bbc0e0b84b51cfbf.js',function(){input.required=false;search();});}
