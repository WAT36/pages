...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.379dc2ecac4bdd925d7e191ff02f399e123489a922109a9e185fdeaad18a5a14.js',function(){input.required=false;search();});}
