...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.470ac7a968467facef94f1356a1f198256b5f560bb0729621fac020a6be311dd.js',function(){input.required=false;search();});}
