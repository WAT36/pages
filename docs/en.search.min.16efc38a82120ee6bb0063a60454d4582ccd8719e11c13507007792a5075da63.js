...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.465d24ee7e8e7004542b721439197478a9617742e336b983a8e90cbf0eef87a8.js',function(){input.required=false;search();});}
