...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b4d25e8487ee507178838049827584825da2a686620db1cf91249ecfdc93eba6.js',function(){input.required=false;search();});}
