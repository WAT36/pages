...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8d6abe6b1f0ea74936f4fe1e26efdbabbe1ecf4590b4fc156192327deb7cf1cd.js',function(){input.required=false;search();});}
