...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.290ea48b793c5143b3a32503fad6556f6acb75b5cc88aa93f8e60d818562de28.js',function(){input.required=false;search();});}
