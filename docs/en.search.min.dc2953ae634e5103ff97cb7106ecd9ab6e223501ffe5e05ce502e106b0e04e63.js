...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3c560c2b18f3be23094177e0faceb19adb3022ba66759215eb86491e99277cc7.js',function(){input.required=false;search();});}
