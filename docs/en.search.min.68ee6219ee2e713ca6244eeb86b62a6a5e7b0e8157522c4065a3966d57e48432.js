...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fdedc44936d8e2658c4fa6d1e2e11594032d5e58c58c2718da19930a938cba6d.js',function(){input.required=false;search();});}
