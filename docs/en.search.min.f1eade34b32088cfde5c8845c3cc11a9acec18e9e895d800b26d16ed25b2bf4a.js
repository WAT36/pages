...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7af2189ec96d3333dee6598a272d76c95442f6d4d8b6add0f3bf465d8fa6342c.js',function(){input.required=false;search();});}
