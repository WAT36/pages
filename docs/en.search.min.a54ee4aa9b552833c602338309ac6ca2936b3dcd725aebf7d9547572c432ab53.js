...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.317d9a98e161383b0ae7e2d78b6d732f29fc7fa0bcf88bb171a690d8cbd7accc.js',function(){input.required=false;search();});}
