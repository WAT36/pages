...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.227871f93bc1a6c7a9eea5191a91aecad3e3f64cb37fa7abbc1e1b5090a02c75.js',function(){input.required=false;search();});}
