...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.67daa0d5fbed084bc1388b354a49aedf9eb404bdc717c96eef8e5c897603ccb2.js',function(){input.required=false;search();});}
