...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e978faf60e2c4bd71a3bc9405eb80951cea8b1ab23de8ca0850c3ac5c4be037d.js',function(){input.required=false;search();});}
