...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e1c5bbb42e20eb66da15effcfcc90d497ebdf6042932a8d66c26531236c1217b.js',function(){input.required=false;search();});}
