...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f09227fef6d101d22f52ae9156dac4dc15107196e14a6e5ef010e84a8a104f77.js',function(){input.required=false;search();});}
