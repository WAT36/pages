...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d0a2f28f61edf7430cc4b9524e30a9bd8edc43b54caf9eb4320bc44384f5cfdc.js',function(){input.required=false;search();});}
