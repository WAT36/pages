...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.323e6715f2473ba0550fe1181095fee43fe7bf1baddc73b4dfc1cdead32861cc.js',function(){input.required=false;search();});}
