...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5bbfd616c1636b0a79a94c71af8a6af8dddb028dc89564ac95d929c57c808445.js',function(){input.required=false;search();});}
