...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.89adda2f69ea72dba052e58ff4af752beb2a164a84bcc7775d3cea106b740871.js',function(){input.required=false;search();});}
