...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.51a4b2de3601aad6ceac08329814abd3e450fe00c275ecf6cf334576bc6689db.js',function(){input.required=false;search();});}
