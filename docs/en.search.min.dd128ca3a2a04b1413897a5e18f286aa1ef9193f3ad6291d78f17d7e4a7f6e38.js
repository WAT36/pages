...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.69278012b5f4adb1a096467a04bf97a0e4b29175e11ea1b895aec2ab4b1ae5b1.js',function(){input.required=false;search();});}
