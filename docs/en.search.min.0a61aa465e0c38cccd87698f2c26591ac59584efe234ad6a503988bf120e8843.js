...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.473fbfbdea69510de20ae9ebef7563eb06a02fb4f20cdf56844ebb9e626c4c88.js',function(){input.required=false;search();});}
