...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c4bae59fcdb17cdde38b05a23d12c3f21becddd4b06e15b5938563bc64a460d6.js',function(){input.required=false;search();});}
