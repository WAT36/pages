...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3fc43d2f47b40d259160ee66e3fbf2f8fba1a74c6049cc3266978a7ae9b6ea0a.js',function(){input.required=false;search();});}
