...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.56ba3f76b9d0e4aa165892a9007fde24b53ab798e18f2c0d8b232d0c7c6970f4.js',function(){input.required=false;search();});}
