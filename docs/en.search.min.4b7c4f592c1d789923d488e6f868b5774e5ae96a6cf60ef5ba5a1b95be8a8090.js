...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.39ed690ae88d2125eb8cf478ec1cd041337514661eb5cde4c664c1dab429bf49.js',function(){input.required=false;search();});}
