...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1110e8d4a420a36663899460ba9325189b3c3404c3065ea2a979ea8f24e83447.js',function(){input.required=false;search();});}
