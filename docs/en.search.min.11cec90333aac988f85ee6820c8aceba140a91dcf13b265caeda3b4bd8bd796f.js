...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c26dab868967423026395453395ffbdafdef15f02ddec196bb2e07fcb08aa597.js',function(){input.required=false;search();});}
