...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ec32a3de36b7fba6230a0e53d53f5149652678afa1953c10c774d947034a7597.js',function(){input.required=false;search();});}
