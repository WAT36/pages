...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cf3446ffe43794787a93424053be9f70282fec754ff743a0fc34138d6333ec02.js',function(){input.required=false;search();});}
