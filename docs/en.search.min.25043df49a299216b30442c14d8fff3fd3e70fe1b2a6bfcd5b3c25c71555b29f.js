...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.54c096e925666e43b81533c5cdad0b46b3e1e6e912d38d05d2cd3728553eadac.js',function(){input.required=false;search();});}
