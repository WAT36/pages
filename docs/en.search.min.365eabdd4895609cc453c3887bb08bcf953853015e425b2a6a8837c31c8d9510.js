...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.00bc2035250d18aaafe2913fc88fa864800577881244049da095160466d6e12e.js',function(){input.required=false;search();});}
