...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aa875e576382667df3de425d2cfbb224b026daf1825ddf2a15d905e0a4d52e4a.js',function(){input.required=false;search();});}
