...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1cbffbab29dffae90f2d8bc37cebe067c03f8c162a98bbe993120abb8a1da58e.js',function(){input.required=false;search();});}
