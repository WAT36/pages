...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.45b88fbc7f0ac3fc893faa02fdc75e6a556c5422aa2125106abc373f8b205175.js',function(){input.required=false;search();});}
