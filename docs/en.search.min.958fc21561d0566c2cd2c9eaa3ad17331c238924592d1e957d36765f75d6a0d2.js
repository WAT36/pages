...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.81d92b0547662a63d9382e6c9322251f40abf4f989064c9b13a6f44a2087bf56.js',function(){input.required=false;search();});}
