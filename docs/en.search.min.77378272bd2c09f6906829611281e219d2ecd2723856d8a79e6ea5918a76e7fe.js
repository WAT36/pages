...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8b29b5a4a87c7e0eb69b90fffd53e3d64ae8532029d1aed9231c384793394379.js',function(){input.required=false;search();});}
