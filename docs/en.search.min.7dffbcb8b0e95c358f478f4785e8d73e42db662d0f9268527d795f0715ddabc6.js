...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6d7d80fdf7fe5df4ac0fdfb67c347df531b5b3675c5bd960c13fb0118aef1d79.js',function(){input.required=false;search();});}
