...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8da35cddee95cee8cd364529d8bc47a4bc661a92794869849f20b9ec9e9c50f7.js',function(){input.required=false;search();});}
