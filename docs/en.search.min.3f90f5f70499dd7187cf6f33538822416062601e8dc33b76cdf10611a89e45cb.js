...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b46874bf46cd92083bcf0c07bed20ff4a5355ded82d31a217341bc004fd4a821.js',function(){input.required=false;search();});}
