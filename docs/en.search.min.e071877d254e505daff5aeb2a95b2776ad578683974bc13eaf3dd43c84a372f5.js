...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7bb35bfe9b33a6631f75b5e1a190cf094e0a78863ae67d5d43be6c0d030a12a4.js',function(){input.required=false;search();});}
