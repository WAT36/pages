...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.39e87e87548b14d3f9aaf7ea05bf183c47bf5408fb4eeae1aa693db118384abf.js',function(){input.required=false;search();});}
