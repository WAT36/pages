...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1645673a64bf18099218372e3d310d5e108938239dfaaa1bb34ded2e4576910c.js',function(){input.required=false;search();});}
