...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.85c97e83986405d3eebbc22c4efcd9421392421a02071e618fac9620282984e9.js',function(){input.required=false;search();});}
