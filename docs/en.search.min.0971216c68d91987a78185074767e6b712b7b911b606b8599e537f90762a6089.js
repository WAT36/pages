...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5673d760a363f802c64b3dfafb2974f45c1569fb66dd88d159534d5554909afb.js',function(){input.required=false;search();});}
