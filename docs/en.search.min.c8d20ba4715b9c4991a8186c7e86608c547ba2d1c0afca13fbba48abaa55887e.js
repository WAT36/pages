...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.54976b0a1a8f864bed1519a1322e05aaa995d1235f4a0ffc04f612fab618e1ca.js',function(){input.required=false;search();});}
