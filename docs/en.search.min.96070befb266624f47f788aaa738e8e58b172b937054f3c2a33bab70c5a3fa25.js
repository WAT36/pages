...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bf018160980fff1c1255a004e5be65ee7ba42960135118b7f25fb6d5c54eae13.js',function(){input.required=false;search();});}
