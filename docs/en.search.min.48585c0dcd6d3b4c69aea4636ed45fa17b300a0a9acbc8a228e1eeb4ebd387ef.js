...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7959a5ea879fbd1889ab6a2604205359480ecc58538e3b7480fae0a6535b4ff3.js',function(){input.required=false;search();});}
