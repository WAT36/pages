...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.97c9aff220df7258763dd921fd2412879129ea98c6fecc691b0e9ba6666f22fd.js',function(){input.required=false;search();});}
